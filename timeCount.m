% function output = timeQuantile(signal, signalTime, timeVector, timeWindow)
% Count the number of values in a time series within timeWindow seconds 
%
